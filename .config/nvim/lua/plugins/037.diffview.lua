...
return {
  ...
  opts = function()
    ...
    -- Set the default border style for panel floats.
    ...
    return {
      ...
      keymaps = {
        -- Only custom keymaps will be used.
        ...
        view = {
          ...
          -- These may be a table of mappings, so we splice them in.
          table.unpack(actions.compat.fold_cmds),
        },
        diff2 = {
